...
var lineChartConfig = {
	...
	data: {
		...
		datasets: [{
			label: 'Dataset',
			backgroundColor: "rgba(172, 47, 48,0.2)", 
			borderColor: "rgba(172, 47, 48, 0.8)", 
			data: [
				randomDataPoint(),
				randomDataPoint(),
				randomDataPoint(),
...
var barChartConfig = {
	...
	data: {
		...
		datasets: [{
			label: 'Dataset 1',
			backgroundColor: "rgba(172, 47, 48,0.8)", 
			hoverBackgroundColor: "rgba(172, 47, 48,1)",
